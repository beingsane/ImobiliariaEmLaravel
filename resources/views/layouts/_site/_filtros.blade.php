	...
	<form action="{{ route('site.busca') }}">
		...
		<div class="input-field col s6 m4">
			<select name="cidade_id">
				<option {{ isset($busca['cidade_id']) && $busca['cidade_id'] == 'todas' ? 'selected' : '' }} value="todas">Todas as Cidades</option>
		...
		<div class="input-field col s12 m4">
			<select name="valor">
				...
				<option {{ isset($busca['valor']) && $busca['valor'] == 4 ? 'selected' : '' }} value="4">De R$ 5.000,00 a R$ 10.000,00</option>
				...
				<option {{ isset($busca['valor']) && $busca['valor'] == 7 ? 'selected' : '' }} value="7">De R$ 100.000,00 a R$ 500.000,00</option>
				<option {{ isset($busca['valor']) && $busca['valor'] == 8 ? 'selected' : '' }} value="8">De R$ 500.000,00 a R$ 1.000.000,00</option>
				<option {{ isset($busca['valor']) && $busca['valor'] == 9 ? 'selected' : '' }} value="9">Acima de R$ 1.000.000,00</option>
			</select>
			<label>Valor</label>
		</div>

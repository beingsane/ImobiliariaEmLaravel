        ...
        <nav>
            <div class="nav-wrapper green">
                <div class="col s12">
                    ...
                    <a class="breadcrumb">Galerias de imagens</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn red" href="javascript: if (confirm('Apagar esse registro?')){ window.location.href = '{{ route('admin.galerias.deletar', $registro->id) }}' }">Deletar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
